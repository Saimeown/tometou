...
<nav>
    ...
    <script>
        ...
        function saveProfileIcon() {
            ...
            var updatedImageUrl = "../images/profile/" + selectedProfileIcon + "?nocache=" + Math.random();
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    document.getElementById("profile-icon").querySelector('.icon').src = updatedImageUrl;
                }
            };
