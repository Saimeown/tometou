...
<nav>
    ...
    <section id="submitpost">
        <div><br><br><br>
            <span><a href="submitpost_admin.php"><button class="submitbutton">SPILL YOUR SAUCE</button></a></span>
        </div>
    </section><br><br><br>
    ...
    <section id="posts">
        <div class="sub">
            <ul>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        if ($iconResult->num_rows > 0) {
                            ...
                            echo '<form method="post" action="delete_post_admin.php">';
                ...
                $conn->close();
                ?>
                <form method="post" action="../assets/submitpost_handler_admin.php">
